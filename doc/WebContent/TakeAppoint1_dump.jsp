...
<table width="100%" height="300"  border="0" cellpadding="2" cellspacing="2" background="images/backgroun6.jpg">
  <tr>
...
<%
	...
	%>
		    ...
		    <table width="100%" height="200"  border="1" background="images/backgroun6.jpg" >
          <tr>
