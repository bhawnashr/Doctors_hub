...
<table width="100%"  border="1" cellpadding="2" cellspacing="2" background="images/backgroun6.jpg">
  <tr>
  ...
  System.out.println("mofy4");
   ...
   update1=CBean.executeUpdate();
	 System.out.println("<---------updated------>");
	  %>
      <table width="100%" height="270"  border="1" background="images/backgroun6.jpg">
          <tr>
