...
public class User_search_send extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		{   
						...
						qry.append("select sno, fname, lname,desg, qual, spelz, exp, foe, university, mobile, email, sex, dob, joindate, type   from MainLoginTable where");                                                         
                            if(fname!=null){
		...
		RequestDispatcher dispatcher =request.getRequestDispatcher("SendMessage1.jsp");
