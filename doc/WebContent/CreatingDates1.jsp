...
<%
	...
	%>
          ...
          <tr>
            <td height="150"><p align="center"><a href="CreatingDates.jsp?did=<%=did%>"><strong><font size="6" face"Georgia">GoBack to Add Another Date</strong></a></p>
              <p align="center"><a href="DoctorMainPage.jsp?did=<%=did%>"><strong><font size="6" face="Georgia">Home</strong></a></p>
            <p>&nbsp; </p></td>
          </tr>
      </table>
