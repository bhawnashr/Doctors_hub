...
<%@include file="LogoutIcon.jsp"%> 
      ...
      <table width="98%" height="450"  border="0" >
         <form method="POST" name="form1" action="usearch" onSubmit="return Validate_search(this)">
		  <tr>
            <td height="450"><table width="900" border="0" align="center">
              <tr height="40" style="font-size:25px;">
                <td  width="17" align="center">&nbsp;</td>
                <td width="700" align="center"><span class="style1">Search for a User for Modify</span></td>
